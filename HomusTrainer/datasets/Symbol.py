...
class Symbol:
    ...
    @staticmethod
    def initialize_from_string(content:str):
        """
...
#
    ...
    def draw_into_bitmap(self, export_file_name:str, stroke_thickness:int, margin:int, destination_width:int, destination_height:int):
        pass
