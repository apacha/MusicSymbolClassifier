...
def test_model(model_path: str, model_name: str, image_paths: List[str]):
    # # Model that uses no fixed canvas
    # model_path = "C:\\Users\\Alex\\Repositories\\MusicSymbolClassifier\\HomusTrainer\\results\\2017-07-19_vgg4_96x96px_98p.h5"
    # model_name = "vgg4"

    # # Model that uses fixed 192x96 canvas
    # model_path = "C:\\Users\\Alex\\Repositories\\MusicSymbolClassifier\\HomusTrainer\\results\\2017-07-03_res_net_3_small - 98.0p.h5"
    # model_name = "res_net_3"

    # image_path = "C:\\Users\\Alex\\Repositories\\MusicSymbolClassifier\\HomusTrainer\\testdata\\Quarter-Note\\1.png"
