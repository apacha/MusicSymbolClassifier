...
python datasets/TrainingDatasetProvider.py --dataset_directory="data" --disable_fixed_canvas_size --datasets homus,rebelo1,rebelo2,printed,audiveris,muscima_pp,fornes
Stop-Transcript